...
public class Demo {
    public static void main(String[] args) {
        ...
        lesson15.task3.BookingComAPI emptyBookingComAPI = new BookingComAPI(emptyRoomArray);

        TripAdvisorAPI TripAdvisorAPI = new TripAdvisorAPI(rooms);
        lesson15.task3.TripAdvisorAPI emptyTripAdvisorAPI = new TripAdvisorAPI(emptyRoomArray);
